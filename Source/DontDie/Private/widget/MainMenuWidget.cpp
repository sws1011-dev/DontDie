...
#include "widget/PersistentUpgradeWidget.h"
...
void UMainMenuWidget::NativeConstruct()
{
	...
	if (Btn_Camp)
	{
		Btn_Camp->OnClicked.AddDynamic(this, &UMainMenuWidget::OnCampClicked);
	}
...
void UMainMenuWidget::OnCampClicked()
{
	UE_LOG(LogTemp, Warning, TEXT("MainMenuWidget::OnCampClicked"));
	UGameplayStatics::OpenLevel(GetWorld(), CampLevelName);
}
